          ...
          children: [
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                if(context.mounted){Navigator.push(context, MaterialPageRoute(builder: (context) => QrCodePage(ssID: ssID!, workSheet: selectedSheet, qrColumns: qrIndex, checkColumn: targetColumn,)),);}
              },
